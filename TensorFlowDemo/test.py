...
RETRAINED_LABELS_TXT_FILE_LOC = os.getcwd() + "/TensorFlowDemo/" + "retrained_labels.txt"
RETRAINED_GRAPH_PB_FILE_LOC = os.getcwd() + "/TensorFlowDemo/" + "retrained_graph.pb"
TEST_IMAGES_DIR = os.getcwd() + "/TensorFlowDemo/test_images"
...
def main():
    ...
    if os.path.exists(os.getcwd() + "/test_images"):
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    # print(classifications.index(strClassification))
                    # if(classifications.index(strClassification) == 1):
                    #     num = -1
                    # else if(classifications.index(strClassification) == 0):
                    #     num = 1
                    # else:
                    #     num = 0
